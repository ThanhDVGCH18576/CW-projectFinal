...
namespace CWFinal_1628.Controllers
{
    public class AssignProjectsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AssignID,ProjectID,BuilderID,SupervisorID,TypeProject")] AssignProject assignProject)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AssignID,ProjectID,BuilderID,SupervisorID,TypeProject")] AssignProject assignProject)
        {
            if (ModelState.IsValid)
            {
