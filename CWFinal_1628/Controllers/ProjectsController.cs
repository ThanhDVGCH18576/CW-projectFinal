...
namespace CWFinal_1628.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProjetcID,ProjectName,Location,StartDate,EndDate,Description,InvestorID,SalesmanID")] Project project)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProjetcID,ProjectName,Location,StartDate,EndDate,Description,InvestorID,SalesmanID")] Project project)
        {
            if (ModelState.IsValid)
            {
